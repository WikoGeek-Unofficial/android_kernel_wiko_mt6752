...
extern signed char otp_read_wb_group_ov5648(signed char index);
extern bool otp_apply_wb_ov5648(unsigned short golden_rg, unsigned short golden_bg);
...
void Cam_sub_ov5648_write_cmos_sensor(kal_uint32 addr, kal_uint32 para)
{
	char pu_send_cmd[3] = {(char)(addr >> 8), (char)(addr & 0xFF), (char)(para & 0xFF)};
	kdSetI2CSpeed(imgsensor_info.i2c_speed); // Add this func to set i2c speed by each sensor
...
extern signed char check_darlingMID(void);
        ...
        do {
            *sensor_id = return_sensor_id();
            if (*sensor_id == imgsensor_info.sensor_id) {
                if( 0==check_darlingMID() ) //it is not darling module
                {	
...
//jiangwei temp begin
#if 0
       otp_update_wb_ov5648(0x178,0x16b);//20141111 llf
#else
    otp_apply_wb_ov5648(0x178, 0x16b);
#endif
//jiangwei temp end
