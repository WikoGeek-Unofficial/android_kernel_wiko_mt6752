...
//#define TINNO_BATTERY_NOTIFY_VCHARGER
...
#define MIN_CHARGE_TEMPERATURE  2 //0   // FFGBKK-556
#define MIN_CHARGE_TEMPERATURE_PLUS_X_DEGREE	(MIN_CHARGE_TEMPERATURE+3)
#else
...
#define V_CC2TOPOFF_THRES		4050
    ...
    // Case1: 0-15.C
    #define HV_CHARGER_CASE1_TEMPERATURE_MIN   MIN_CHARGE_TEMPERATURE //0    // 0.C
    #define HV_CHARGER_CASE1_TEMPERATURE_MAX   15   // 15.C
    #define HV_CHARGER_CASE1_CURRENT            CHARGE_CURRENT_500_00_MA	//492mA
    #define HV_CHARGER_CASE1_TERMINAL_CURRENT   (50)	//50mA
    #define HV_CHARGER_CASE1_VOLTAGE            BATTERY_VOLT_04_380000_V //BATTERY_VOLT_04_340000_V
    ...
    #define HV_CHARGER_CASE2_CURRENT            CHARGE_CURRENT_700_00_MA	//738mA
    ...
    // Case2: 15-45.C
    #define HV_CHARGER_VOLTAGE            BATTERY_VOLT_04_380000_V //BATTERY_VOLT_04_340000_V
#else
    #define RECHARGING_VOLTAGE      4110
    #define CHARGING_FULL_VOLTAGE    4150	//mV
#endif  /* HIGH_BATTERY_VOLTAGE_SUPPORT */
#if defined (TINNO_BATTERY_FEATURE)
    #define CHARGING_FULL_CURRENT    (0+100)	//mA
...
#define APPLE_1_0A_CHARGER_CURRENT          CHARGE_CURRENT_1000_00_MA //CHARGE_CURRENT_650_00_MA
#define APPLE_2_1A_CHARGER_CURRENT          CHARGE_CURRENT_1000_00_MA //CHARGE_CURRENT_800_00_MA
...
#define V_LINEOFF_OFFSET    500
#define V_CHARGER_MAX (6200	- V_LINEOFF_OFFSET)     // 6.2 V
#define V_CHARGER_MIN 4300				            // 4.3 V
#define V_CHARGER_MIN_THL 3600                      // 3.6 V
#else
...
#define NPERCENT_TRACKING_TIME	   			60	// 60 second
#else
