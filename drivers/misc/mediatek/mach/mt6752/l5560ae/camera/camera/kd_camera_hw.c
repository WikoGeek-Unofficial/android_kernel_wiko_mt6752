...
PowerUp PowerOnList={
	{
		...
		{SENSOR_DRVNAME_OV5649_MIPI_RAW,
			{
				{SensorMCLK,Vol_High, 0},
				{DOVDD, Vol_1800, 10},
				{AVDD,  Vol_2800, 10},
		...
		{SENSOR_DRVNAME_IMX215_MIPI_RAW,//add sensor.wupingzhou,20141020.
			{
#if 1	
				{RST,   Vol_High,  40},				
				{AVDD,	Vol_2800, 40},
...
int kdCISModulePowerOn(CAMERA_DUAL_CAMERA_SENSOR_ENUM SensorIdx, char *currSensorName, BOOL On, char* mode_name)
{
    ...
    if (On) {
		...
		{
			PK_DBG("kdCISModulePowerOn -on jiangwei :pwListIdx=%d\n",pwListIdx);
...
//mlck move to power last jiangwei begin
#if 0            
            if(pinSetIdx == 0 ) {
                ISP_MCLK1_EN(1);
            }
...
//mlck move to power last jiangwei begin
            ...
            if (GPIO_CAMERA_INVALID != pinSet[pinSetIdx][IDX_PS_CMRST]) {
                if(0 == pinSetIdx) {
#ifndef MTK_MT6306_SUPPORT
	printk("kdCISModulePowerOn--->main reset\n");
                    if(mt_set_gpio_mode(pinSet[pinSetIdx][IDX_PS_CMRST],pinSet[pinSetIdx][IDX_PS_CMRST+IDX_PS_MODE])){PK_DBG("[CAMERA SENSOR] set gpio mode failed!! (CMRST)\n");}
                    if(mt_set_gpio_dir(pinSet[pinSetIdx][IDX_PS_CMRST],GPIO_DIR_OUT)){PK_DBG("[CAMERA SENSOR] set gpio dir failed!! (CMRST)\n");}
		...
		printk("kdCISModulePowerOn--->sub reset\n");		
                    if(mt_set_gpio_mode(pinSet[pinSetIdx][IDX_PS_CMRST],pinSet[pinSetIdx][IDX_PS_CMRST+IDX_PS_MODE])){PK_DBG("[CAMERA SENSOR] set gpio mode failed!! (CMRST)\n");}
                    if(mt_set_gpio_dir(pinSet[pinSetIdx][IDX_PS_CMRST],GPIO_DIR_OUT)){PK_DBG("[CAMERA SENSOR] set gpio dir failed!! (CMRST)\n");}
                    if(mt_set_gpio_out(pinSet[pinSetIdx][IDX_PS_CMRST],pinSet[pinSetIdx][IDX_PS_CMRST+IDX_PS_OFF])){PK_DBG("[CAMERA SENSOR] set gpio failed!! (CMRST)\n");}
                }                
	   ...
	   mdelay(40);       
	    ...
	    PK_DBG("kdCISModulePowerOn jiangwei VCAM_IO power on 1111111111111111111111111111111\n");
	    ...
	    PK_DBG("kdCISModulePowerOn jiangwei VCAM_A power on   22222222222222222222222222222222222\n");
...
#endif
	    PK_DBG("kdCISModulePowerOn jiangwei 333333333333333333333333333333333333\n");
	    mdelay(40);

	   //VCAM_DVDD
	     if(currSensorName && ((0 == strcmp(SENSOR_DRVNAME_IMX214_MIPI_RAW,currSensorName))||(0 == strcmp(SENSOR_DRVNAME_IMX215_MIPI_RAW,currSensorName))))
	    {
		    	PK_DBG("kdCISModulePowerOn jiangwei main camera VCAM_DVDD power on \n");
	    ...
	    }else if(currSensorName && ((0 == strcmp(SENSOR_DRVNAME_OV5648_MIPI_RAW,currSensorName))||(0 == strcmp(SENSOR_DRVNAME_OV5649_MIPI_RAW,currSensorName))))
	    {
		    	PK_DBG("kdCISModulePowerOn jiangwei sub camera VCAM_DVDD power on \n");
	    ...
	    PK_DBG("kdCISModulePowerOn jiangwei 4444444444444444444444444444444444444\n");

	    if(currSensorName && ((0 == strcmp(SENSOR_DRVNAME_IMX214_MIPI_RAW,currSensorName))||(0 == strcmp(SENSOR_DRVNAME_IMX215_MIPI_RAW,currSensorName))))
	    {
		    PK_DBG("kdCISModulePowerOn jiangwei AF_VCC power on \n");
	...
	for(pwListIdx=0 ; pwListIdx<16; pwListIdx++)
	    ...
	    PK_DBG("kdCISModulePowerDown  jiangwei 111111111111111111111111111\n");
            
	   //VCAM_DVDD
	     if(currSensorName && ((0 == strcmp(SENSOR_DRVNAME_IMX214_MIPI_RAW,currSensorName))||(0 == strcmp(SENSOR_DRVNAME_IMX215_MIPI_RAW,currSensorName))))
	    {

	   		 PK_DBG("kdCISModulePowerDown  jiangwei main camera  VCAM_DVDD down\n");
	    ...
	    {
	   		 PK_DBG("kdCISModulePowerDown  jiangwei sub camera  VCAM_DVDD down\n");
	    ...
	    PK_DBG("kdCISModulePowerDown  jiangwei VCAM_A  2222222222222222222222222222\n");
	    ...
	    PK_DBG("kdCISModulePowerDown  jiangwei  VCAM_IO 333333333333333333333333333333333\n");
	    ...
	    PK_DBG("kdCISModulePowerDown  jiangwei 4444444444444444444444444444444444\n");

  	    if(currSensorName && ((0 == strcmp(SENSOR_DRVNAME_IMX214_MIPI_RAW,currSensorName))||(0 == strcmp(SENSOR_DRVNAME_IMX215_MIPI_RAW,currSensorName))))
	    {
		    PK_DBG("kdCISModulePowerDown  jiangwei AF_VCC down\n");
