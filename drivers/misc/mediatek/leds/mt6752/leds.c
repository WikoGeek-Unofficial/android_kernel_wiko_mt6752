...
#define LED0_ISINK   ISINK_0 // Red: 4mA
#define LED1_ISINK   ISINK_0 // Green: 4mA
#define LED2_ISINK   ISINK_0 // 4mA
#define LED3_ISINK   ISINK_0 // Blue: 4mA
#else
#define LED0_ISINK   ISINK_3 // 16mA
#define LED1_ISINK   ISINK_3 // 16mA
#define LED2_ISINK   ISINK_3 // 16mA
#define LED3_ISINK   ISINK_3 // 16mA
#endif  /* TINNO_ANDROID_L5560AE */
...
int mt_led_blink_pmic(enum mt65xx_led_pmic pmic_type, struct nled_setting *led)
{
	...
	switch(pmic_type){
		case MT65XX_LED_PMIC_NLED_ISINK0:
			...
			mt6325_upmu_set_isink_ch0_step(LED0_ISINK);//16mA
		...
		case MT65XX_LED_PMIC_NLED_ISINK1:
			...
			mt6325_upmu_set_isink_ch1_step(LED1_ISINK);//16mA
		...
		case MT65XX_LED_PMIC_NLED_ISINK2:
			...
			mt6325_upmu_set_isink_ch2_step(LED2_ISINK);//16mA
		...
		case MT65XX_LED_PMIC_NLED_ISINK3:
			...
			mt6325_upmu_set_isink_ch3_mode(PMIC_PWM_0);
			mt6325_upmu_set_isink_ch3_step(LED3_ISINK);//16mA
