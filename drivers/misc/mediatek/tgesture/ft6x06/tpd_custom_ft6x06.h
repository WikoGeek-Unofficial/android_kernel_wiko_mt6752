...
#define CUST_EINT_GESTURE_PANEL_NUM              4
#define CUST_EINT_GESTURE_PANEL_DEBOUNCE_CN      0
#define CUST_EINT_GESTURE_PANEL_TYPE							CUST_EINTF_TRIGGER_FALLING
#define CUST_EINT_GESTURE_PANEL_DEBOUNCE_EN      CUST_EINT_DEBOUNCE_DISABLE
