...
#define FLASH_GPIO_ENE   (GPIO118 | 0x80000000)//(GPIO114 | 0x80000000)
#define FLASH_GPIO_ENS	 (GPIO122 | 0x80000000)//(GPIO118 | 0x80000000)
#define FLASH_GPIO_ENT  (GPIO119 | 0x80000000)//(GPIO126 | 0x80000000)   
...
int FL_Enable(void)
{
	...
	PK_DBG(" FL_Enable  LED2 line=%d reg0 %d\n",__LINE__, (int)bufR[0]);
	PK_DBG("FL_enable :g_duty=%d \n",gDuty);



#if 1
		//iWriteReg(0x05, 0x7F, 1, STROBE_DEVICE_ID);
		//iWriteReg(0x06, 0x00, 1, STROBE_DEVICE_ID);
		//iWriteReg(0x07, 0x00, 1, STROBE_DEVICE_ID);
	if(gDuty == 0)
	{
		iWriteReg_led(0x05, 0x30, 1, STROBE_DEVICE_ID);//ES ????t?¡§|??¨¨¡§|¡§¡é1a|¨¬?¡§o??¡è??¡§|¡§???¨º??Y¡§o?¨¤?¡§¡§?a???D??
		iWriteReg_led(0x06, 0x00, 1, STROBE_DEVICE_ID);
		iWriteReg_led(0x07, 0x00, 1, STROBE_DEVICE_ID);//iWriteReg_led(0x07, 0x00, 1, STROBE_DEVICE_ID);
		
		PK_DBG(" FL_Enable line=%d\n",__LINE__);
		//iWriteReg(0x01, 0xE2, 1, STROBE_DEVICE_ID);
		iWriteReg_led(0x01, 0xE2, 1, STROBE_DEVICE_ID);  	
	}else if (gDuty == 1){
		iWriteReg_led(0x05, 0x70, 1, STROBE_DEVICE_ID);//ES ????t?¡§|??¨¨¡§|¡§¡é1a|¨¬?¡§o??¡è??¡§|¡§???¨º??Y¡§o?¨¤?¡§¡§?a???D??
		iWriteReg_led(0x06, 0x00, 1, STROBE_DEVICE_ID);
		iWriteReg_led(0x07, 0x00, 1, STROBE_DEVICE_ID);//iWriteReg_led(0x07, 0x00, 1, STROBE_DEVICE_ID);
		...
		iWriteReg_led(0x05, gDuty, 1, STROBE_DEVICE_ID);//ES ????t?¡§|??¨¨¡§|¡§¡é1a|¨¬?¡§o??¡è??¡§|¡§???¨º??Y¡§o?¨¤?¡§¡§?a???D??
		iWriteReg_led(0x06, 0x00, 1, STROBE_DEVICE_ID);
		iWriteReg_led(0x07, 0x00, 1, STROBE_DEVICE_ID);
		
		PK_DBG(" FL_Enable line=%d\n",__LINE__);
		//iWriteReg(0x01, 0xE2, 1, STROBE_DEVICE_ID);
		iWriteReg_led(0x01, 0xE3, 1, STROBE_DEVICE_ID);  
	}
#endif
	kdSetI2CBusNum(3);
...
int Sub_Enable(void)//????t1|?¡§1?¡§|??¨¨?¨º??Y¡§o?¨¤?¡§¡§?a???D??
{
	char buf[2];
	char bufR[2];
	...
	iWriteReg_led(0x05, 0x7F, 1, STROBE_DEVICE_ID);
