...
#define GPIO_AKM_RST_PIN         (GPIO134 | 0x80000000)  
#endif
/*----------------------------------------------------------------------------*/
static int akm09911_i2c_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
	...
	#ifdef TINNO_ANDROID_L8420AE
		mt_set_gpio_mode(GPIO_AKM_RST_PIN,GPIO_MODE_00);

		mt_set_gpio_dir(GPIO_AKM_RST_PIN,GPIO_DIR_OUT);

		mt_set_gpio_out(GPIO_AKM_RST_PIN,GPIO_OUT_ONE);
	#endif
