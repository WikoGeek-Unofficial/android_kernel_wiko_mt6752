...
#if defined(CONFIG_PROJECT_L5560AE_CAS_TR)
#define MANUFACTURER_STRING "Casper"
#define PRODUCT_STRING "VIA V9"

#elif defined(CONFIG_PROJECT_L5560AE_WIK_FR)
#define MANUFACTURER_STRING "WIKO"
#define PRODUCT_STRING "HIGHWAY STAR"

#elif defined(CONFIG_PROJECT_L5560AE_QMB_PK)
#define MANUFACTURER_STRING "QMobile"
#define PRODUCT_STRING "X950"
