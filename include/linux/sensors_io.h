...
#define ALSPS_IOCTL_GET_CALI			_IOR(ALSPS, 0x17, int)
#define ALSPS_IOCTL_SET_CALI			_IOW(ALSPS, 0x18, int)
#define ALSPS_SET_PS_THRESHOLD			_IOW(ALSPS, 0x19, int)
#define ALSPS_SET_ALS_THRESHOLD			_IOW(ALSPS, 0x1A, int)
#define ALSPS_IOCTL_CLR_CALI			_IOW(ALSPS, 0x1B, int)
#ifdef CONFIG_COMPAT
#define COMPAT_ALSPS_GET_PS_RAW_DATA			_IOR(ALSPS, 0x04, compat_int_t)
#define COMPAT_ALSPS_IOCTL_PS_SET_CALI			_IOW(ALSPS, 0x10,  compat_int_t[2])
#endif
